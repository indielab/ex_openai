defmodule ExOpenAI.Components.BetaContainerNetworkPolicyDomainSecretParam do
  use ExOpenAI.Jason

  @moduledoc """
  Module for representing the OpenAI schema BetaContainerNetworkPolicyDomainSecretParam.
