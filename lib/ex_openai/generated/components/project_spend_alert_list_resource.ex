defmodule ExOpenAI.Components.ProjectSpendAlertListResource do
  use ExOpenAI.Jason
  ...
  * `:data` - **required** - `list(ExOpenAI.Components.ProjectSpendAlert.t())`
  ...
  * `:object` - **required** - `:list`
  ...
  @type t() :: %{
          ...
          data: list(ExOpenAI.Components.ProjectSpendAlert.t()),
  ...
  @type input() ::
          t()
          | %{
              required(:data) => list(ExOpenAI.Components.ProjectSpendAlert.input()),
