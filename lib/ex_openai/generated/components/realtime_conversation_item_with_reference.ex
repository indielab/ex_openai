defmodule ExOpenAI.Components.RealtimeConversationItemWithReference do
  ...
  * `:content` - **optional** - `list(%{ optional(:audio) => String.t(), optional(:id) => String.t(), optional(:text) => String.t(), optional(:transcript) => String.t(), optional(:type) => :input_audio | :input_text | :item_reference | :text })`
          ...
          | %{
              ...
              optional(:content) =>
                list(%{
                  ...
                  optional(:transcript) => String.t(),
                  optional(:type) =>
                    (((:input_audio | :input_text) | :item_reference) | :text) | String.t()
                }),
              optional(:id) => String.t(),
              optional(:name) => String.t(),
              optional(:object) => :"realtime.item" | String.t(),
              optional(:output) => String.t(),
              optional(:role) => ((:user | :assistant) | :system) | String.t(),
              optional(:status) => ((:completed | :incomplete) | :in_progress) | String.t(),
              optional(:type) =>
                ((:message | :function_call) | :function_call_output) | String.t()
            }
