defmodule ExOpenAI.Components.ChatCompletionToolChoiceOption do
  ...
  `:none | :auto | :required | ExOpenAI.Components.ChatCompletionAllowedToolsChoice.t() | ExOpenAI.Components.ChatCompletionNamedToolChoice.t() | ExOpenAI.Components.ChatCompletionNamedToolChoiceCustom.t()`
  """
  @type t() ::
          ((((:none | :auto) | :required)
