defmodule ExOpenAI.Components.ImageGenPartialImageEvent do
  use ExOpenAI.Jason
  ...
  * `:type` - **required** - `:"image_generation.partial_image"`
  ...
  @type input() ::
          ...
          | %{
              ...
              required(:type) => :"image_generation.partial_image" | String.t()
            }
  defstruct [
    :b64_json,
    :background,
