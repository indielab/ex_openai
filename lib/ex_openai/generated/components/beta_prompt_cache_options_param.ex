defmodule ExOpenAI.Components.BetaPromptCacheOptionsParam do
  use ExOpenAI.Jason
  ...
  * `:mode` - **optional** - `ExOpenAI.Components.BetaPromptCacheModeEnum.t()`
  ...
  * `:ttl` - **optional** - `ExOpenAI.Components.BetaPromptCacheTTLEnum.t()`
  ...
  @type t() :: %{
          ...
          mode: ExOpenAI.Components.BetaPromptCacheModeEnum.t() | nil,
          ttl: ExOpenAI.Components.BetaPromptCacheTTLEnum.t() | nil
        }
  @typedoc "Accepted struct or atom-keyed input map."
  @type input() ::
          t()
          | %{
              optional(:mode) => ExOpenAI.Components.BetaPromptCacheModeEnum.input(),
              optional(:ttl) => ExOpenAI.Components.BetaPromptCacheTTLEnum.input()
            }
  defstruct [:mode, :ttl]
end
