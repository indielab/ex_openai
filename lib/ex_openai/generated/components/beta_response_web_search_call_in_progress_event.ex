defmodule ExOpenAI.Components.BetaResponseWebSearchCallInProgressEvent do
  use ExOpenAI.Jason
  ...
  * `:type` - **required** - `:"response.web_search_call.in_progress"`
  ...
  @type input() ::
          ...
          | %{
              ...
              required(:type) => :"response.web_search_call.in_progress" | String.t()
            }
