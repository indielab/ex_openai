defmodule ExOpenAI.Components.InputFileContentParam do
  ...
  * `:detail` - **optional** - `ExOpenAI.Components.FileDetailEnum.t()`
  ...
  * `:type` - **required** - `:input_file`
  ...
  @type t() :: %{
          ...
          detail: ExOpenAI.Components.FileDetailEnum.t() | nil,
  ...
  @type input() ::
          t()
          | %{
              optional(:detail) => ExOpenAI.Components.FileDetailEnum.input(),
