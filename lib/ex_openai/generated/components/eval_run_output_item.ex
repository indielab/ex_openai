  ...
  * `:status` - **required** - `String.t()`
  ...
  @type input() ::
          ...
          | %{
              ...
              required(:datasource_item) => map(),
              required(:datasource_item_id) => integer(),
              required(:eval_id) => String.t(),
              required(:id) => String.t(),
              required(:object) => :"eval.run.output_item" | String.t(),
              required(:results) => list(ExOpenAI.Components.EvalRunOutputItemResult.input()),
