defmodule ExOpenAI.Components.BetaWebSearchTool do
  use ExOpenAI.Jason
  ...
  * `:user_location` - **optional** - `ExOpenAI.Components.BetaWebSearchApproximateLocation.t()`
  """
  @type t() :: %{
          ...
          user_location: ExOpenAI.Components.BetaWebSearchApproximateLocation.t() | nil
        }
  ...
  @type input() ::
          ...
          | %{
              ...
              optional(:user_location) =>
                ExOpenAI.Components.BetaWebSearchApproximateLocation.input()
            }
