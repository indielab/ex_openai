defmodule ExOpenAI.Components.ListAuditLogsResponse do
  use ExOpenAI.Jason
  ...
  * `:data` - **required** - `list(ExOpenAI.Components.AuditLog.t())`
  ...
  * `:object` - **required** - `:list`
  ...
  @type t() :: %{
          ...
          data: list(ExOpenAI.Components.AuditLog.t()),
  ...
  @type input() ::
          t()
          | %{
              required(:data) => list(ExOpenAI.Components.AuditLog.input()),
