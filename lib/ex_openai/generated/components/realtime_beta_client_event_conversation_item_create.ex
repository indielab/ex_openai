defmodule ExOpenAI.Components.RealtimeBetaClientEventConversationItemCreate do
  use ExOpenAI.Jason
  ...
  * `:type` - **required** - `:"conversation.item.create"`
  ...
  @type input() ::
          ...
          | %{
              ...
              optional(:previous_item_id) => String.t(),
              required(:type) => :"conversation.item.create" | String.t()
            }
