defmodule ExOpenAI.Components.ProjectSpendAlert do
  use ExOpenAI.Jason
  ...
  * `:object` - **required** - `:"project.spend_alert"`
    The object type, which is always `project.spend_alert`.
    Allowed values: `"project.spend_alert"`
  ...
  * `:threshold_amount` - **required** - `integer()`
  ...
  @type input() ::
          ...
          | %{
              ...
              required(:object) => :"project.spend_alert" | String.t(),
