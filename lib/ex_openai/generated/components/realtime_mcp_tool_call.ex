defmodule ExOpenAI.Components.RealtimeMCPToolCall do
  ...
  * `:error` - **optional** - `ExOpenAI.Components.RealtimeMCPProtocolError.t() | ExOpenAI.Components.RealtimeMCPToolExecutionError.t() | ExOpenAI.Components.RealtimeMCPHTTPError.t() | nil`
  ...
  * `:type` - **required** - `:mcp_call`
  ...
  @type input() ::
          ...
          | %{
              ...
              optional(:error) =>
                ((ExOpenAI.Components.RealtimeMCPProtocolError.input()
                  | ExOpenAI.Components.RealtimeMCPToolExecutionError.input())
                 | ExOpenAI.Components.RealtimeMCPHTTPError.input())
                | nil,
