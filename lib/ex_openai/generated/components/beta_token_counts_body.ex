defmodule ExOpenAI.Components.BetaTokenCountsBody do
  use ExOpenAI.Jason

  @moduledoc """
  Module for representing the OpenAI schema BetaTokenCountsBody.
  ...
  * `:personality` - **optional** - `ExOpenAI.Components.BetaPersonalityEnum.t()`
  ...
  * `:text` - **optional** - `ExOpenAI.Components.BetaResponseTextParam.t() | nil`

  * `:tool_choice` - **optional** - `ExOpenAI.Components.BetaToolChoiceParam.t() | nil`

  * `:tools` - **optional** - `list(ExOpenAI.Components.BetaTool.t()) | nil`

  * `:truncation` - **optional** - `ExOpenAI.Components.BetaTruncationEnum.t()`
  ...
  @type t() :: %{
          ...
          personality: ExOpenAI.Components.BetaPersonalityEnum.t() | nil,
          previous_response_id: (String.t() | nil) | nil,
          reasoning: (ExOpenAI.Components.BetaReasoning.t() | nil) | nil,
          text: (ExOpenAI.Components.BetaResponseTextParam.t() | nil) | nil,
          tool_choice: (ExOpenAI.Components.BetaToolChoiceParam.t() | nil) | nil,
          tools: (list(ExOpenAI.Components.BetaTool.t()) | nil) | nil,
          truncation: ExOpenAI.Components.BetaTruncationEnum.t() | nil
        }
  ...
  @type input() ::
          ...
          | %{
              ...
              optional(:personality) => ExOpenAI.Components.BetaPersonalityEnum.input(),
              optional(:previous_response_id) => String.t() | nil,
              optional(:reasoning) => ExOpenAI.Components.BetaReasoning.input() | nil,
              optional(:text) => ExOpenAI.Components.BetaResponseTextParam.input() | nil,
              optional(:tool_choice) => ExOpenAI.Components.BetaToolChoiceParam.input() | nil,
              optional(:tools) => list(ExOpenAI.Components.BetaTool.input()) | nil,
              optional(:truncation) => ExOpenAI.Components.BetaTruncationEnum.input()
            }
  defstruct [
    :conversation,
    :input,
