defmodule ExOpenAI.Components.RealtimeSessionCreateResponseGA do
  ...
  * `:audio` - **optional** - `%{ optional(:input) => %{ optional(:format) => ExOpenAI.Components.RealtimeAudioFormats.t(), optional(:noise_reduction) => %{optional(:type) => ExOpenAI.Components.NoiseReductionType.t()}, optional(:transcription) => ExOpenAI.Components.AudioTranscriptionResponse.t(), optional(:turn_detection) => ExOpenAI.Components.RealtimeTurnDetection.t() }, optional(:output) => %{ optional(:format) => ExOpenAI.Components.RealtimeAudioFormats.t(), optional(:speed) => number(), optional(:voice) => ExOpenAI.Components.VoiceIdsShared.t() } }`
  ...
  * `:object` - **required** - `:"realtime.session"`
          ...
          | %{
              ...
              optional(:model) =>
                ...
                | ((((((((((((((((((:"gpt-realtime" | :"gpt-realtime-1.5") | :"gpt-realtime-2")
                   ...
                   | :"gpt-audio-mini-2025-12-15")
                | String.t(),
              required(:object) => :"realtime.session" | String.t(),
