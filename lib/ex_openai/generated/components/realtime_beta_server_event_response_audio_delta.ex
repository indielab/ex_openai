defmodule ExOpenAI.Components.RealtimeBetaServerEventResponseAudioDelta do
  use ExOpenAI.Jason
  ...
  * `:type` - **required** - `:"response.output_audio.delta"`
    The event type, must be `response.output_audio.delta`.
    Allowed values: `"response.output_audio.delta"`
  """
  @type t() :: %{
  ...
  @type input() ::
          ...
          | %{
              ...
              required(:type) => :"response.output_audio.delta" | String.t()
            }
