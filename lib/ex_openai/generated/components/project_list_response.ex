defmodule ExOpenAI.Components.ProjectListResponse do
  use ExOpenAI.Jason
  ...
  * `:data` - **required** - `list(ExOpenAI.Components.Project.t())`
  ...
  * `:object` - **required** - `:list`
  ...
  @type t() :: %{
          ...
          data: list(ExOpenAI.Components.Project.t()),
  ...
  @type input() ::
          t()
          | %{
              required(:data) => list(ExOpenAI.Components.Project.input()),
