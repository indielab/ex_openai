defmodule ExOpenAI.Components.InputFileContent do
  ...
  * `:detail` - **optional** - `ExOpenAI.Components.FileInputDetail.t()`
  ...
  * `:type` - **required** - `:input_file`
  ...
  @type t() :: %{
          ...
          detail: ExOpenAI.Components.FileInputDetail.t() | nil,
  ...
  @type input() ::
          t()
          | %{
              optional(:detail) => ExOpenAI.Components.FileInputDetail.input(),
