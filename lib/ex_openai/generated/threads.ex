defmodule ExOpenAI.Threads do
  ...
  (
    ...
    * `response_format` - **optional** - `any() | nil`
    ...
    * `tool_resources` - **optional** - `any() | nil`  
      A set of resources that are used by the assistant's tools. The resources are specific to the type of tool. For example, the `code_interpreter` tool requires a list of file IDs, while the `file_search` tool requires a list of vector store IDs.

    * `tools` - **optional** - `[any() | any() | any()] | nil`  
  ...
  (
    ...
    * `:run_id` - **optional** - `String.t()`  
    ...
    def list_messages(thread_id, opts \\ []) do
      ...
      url = url <> query_string
      body_params = []
      optional_body_params = Keyword.take(opts, [:after, :before, :limit, :order, :run_id])
      body_params = body_params ++ optional_body_params
  ...
  (
    ...
    * `content` - **required** - `String.t() | [any() | any() | any()]`
  ...
  (
    ...
    * `additional_messages` - **optional** - `[any()] | nil`  
    ...
    * `model` - **optional** - `String.t() | any() | nil`  
      The ID of the [Model](/docs/api-reference/models) to be used to execute this run. If a value is provided here, it will override the model associated with the assistant. If not, the model associated with the assistant will be used.  
      Example: `"gpt-4o"`
    ...
    @spec create_run(
            ...
            opts :: [
              ((((((((((((((({:"include[]", any()} | {:additional_instructions, String.t() | nil})
                        ...
                        | {:metadata, ExOpenAI.Components.Metadata.t()})
                       | {:model,
                          (String.t() | ExOpenAI.Components.AssistantSupportedModels.t()) | nil})
                      | {:parallel_tool_calls, ExOpenAI.Components.ParallelToolCalls.t()})
  ...
  (
    ...
    * `:include[]` - **optional** - `[String.t()]`  
    ...
    def list_run_steps(run_id, thread_id, opts \\ []) do
      ...
      url = url <> query_string
      body_params = []
      optional_body_params = Keyword.take(opts, [:after, :before, :"include[]", :limit, :order])
      body_params = body_params ++ optional_body_params
