defmodule ExOpenAI.Realtime do
  ...
  (
    ...
    * `tool_choice` - **optional** - `any() | any() | any()`  
              ...
              ((((((((({:audio,
                        %{
                          optional(:input) => %{
                            ...
                            optional(:transcription) =>
                              ExOpenAI.Components.AudioTranscription.t(),
                            optional(:turn_detection) =>
                              ExOpenAI.Components.RealtimeTurnDetection.t()
                          },
                          optional(:output) => %{
                            optional(:format) => ExOpenAI.Components.RealtimeAudioFormats.t(),
                            optional(:speed) => number(),
                    ...
                    | {:model,
                       ...
                       | ((((((((((((((:"gpt-realtime" | :"gpt-realtime-1.5")
                          ...
                          | :"gpt-audio-mini-2025-10-06")
                       | :"gpt-audio-mini-2025-12-15"})
                   | {:output_modalities, list(:text | :audio)})
  ...
  (
    ...
    * `input_audio_transcription` - **optional** - `any()`  
  ...
  (
    ...
    * `input_audio_noise_reduction` - **optional** - `any()`  
            ...
            opts :: [
              ((({:include, list(:"item.input_audio_transcription.logprobs")}
                ...
                | {:input_audio_noise_reduction,
                   %{optional(:type) => ExOpenAI.Components.NoiseReductionType.t()}})
               | {:input_audio_transcription, ExOpenAI.Components.AudioTranscription.t()})
              | {:turn_detection,
                 %{
                   optional(:prefix_padding_ms) => integer(),
                   optional(:silence_duration_ms) => integer(),
