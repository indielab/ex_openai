defmodule ExOpenAI.Completions do
  @moduledoc """
  Functions for the OpenAI completions API.
  """
  (
    @doc """
    ...
    * `model` - **required** - `String.t() | :"gpt-3.5-turbo-instruct" | :"davinci-002" | :"babbage-002" | String.t()`
    ...
    (
      @type create_completion_opt() ::
              ((((((((((((((({:best_of, integer() | nil} | {:echo, boolean() | nil})
                    ...
                    | {:stream, boolean() | nil})
                   | {:stream_options, ExOpenAI.Components.ChatCompletionStreamOptions.input()})
                  | {:suffix, String.t() | nil})
